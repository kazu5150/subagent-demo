...
Claude Codeがサブエージェントを内部で使用することで、以下のメリットがあります。
...
以下のプロンプトを**普通にClaude Codeに入力**してみてください。内部でどのサブエージェントが使われるか観察できます。
...
### 複雑なタスク（→ general-purpose）
```
UserServiceクラスにバリデーション機能を追加し、テストも書いてください。
```
